...
void display()
{
    ...
    screen_box(0, wh - ww / 10 - ww/10, ww / 10);//the second one, in red

    glColor3f(0.0, 1.0, 0.0);
    screen_box(0, wh - ww / 10 - 2*ww / 10, ww / 10);//the third one, in green

    glColor3f(0.0, 0.0, 1.0);
    screen_box(0, wh - ww / 10 - 3*ww / 10, ww / 10);//the fourth one, in blue

    glColor3f(1.0, 1.0, 0.0);
    screen_box(0, wh - ww / 10 - 4*ww / 10, ww / 10);//the fifth one, in yellow
    ...
    glPointSize(3.0);
    glBegin(GL_POINTS);
    glVertex2i(ww/10/2-1, wh - ww / 10 - 2.5 * ww / 10);
    glEnd();

    glRasterPos2i(ww/100, wh - ww / 10 - 3.7*ww/10);
...
int main(int argc, char** argv)
{
    ...
    glutAddMenuEntry("double pixel size", 1);
    glutAddMenuEntry("triple pixel size", 2);
    glutAddMenuEntry("halve pixel size", 3);
